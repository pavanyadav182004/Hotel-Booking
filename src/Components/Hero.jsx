...
const Hero = () => {
    ...
    bg-no-repeat bg-cover bg-center h-screen '>
            ...
            {/* second-div */}
            <div>
                <p className='bg-[#49b9ff]/50 px-3.5 py-1 w-70 rounded-full mt-20'>
                    The  Ultimate Hotel Experience</p>

                <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>
                    Discover your perfect Geteway Destination</h1>

                <p>Unparalleled luxery and comfort await at the world's most exclusive <br /> hotels and resorts. Start your journey today.</p>
                ...
                md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
                    ...
                    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
                        ...
                        <input
                            ...
                            min={1} max={4} id="guests" type="number" className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none  max-w-16" placeholder="0" />
                    </div>
